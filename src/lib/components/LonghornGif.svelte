            ...
            <div class="card p-4 w-72 variant-filled-tertiary" data-popup="popupClick">
                <span class="longhornGif">
                    <div style="width:100%;height:0;padding-bottom:56%;position:relative;">
                        <iframe src="https://giphy.com/embed/L2g7SGGUlP4GUFj9Vm" title="longhornGIF" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
                    </div><p><a href="https://giphy.com/gifs/espn-sports-fan-sad-texas-L2g7SGGUlP4GUFj9Vm">Sad Longhorn via GIPHY</a></p>
                </span>
